...
def mostrar_despacho(id_despacho):
    if id_despacho in despachos_propietario:
        despacho = despachos_propietario[id_despacho]
...
while True:
    print('\n<<<<< MENÚ PRINCIPAL >>>>>')
    print('1. Registrar el despacho')
    print('2. Mostrar el despacho')
    opcion = input('-> ')
    if opcion == '1':
